                            ...
                            <Grid item key={form.id} sx={{ width: "530px" }}>
                                ...
                                >
                                    ...
                                    <Box sx={{ p: 3, flexGrow: 1 }}>
                                        <Typography variant="h6" gutterBottom sx={{ fontWeight: "bold", color: "#384486" }}>
                                            {form?.card_heading}
                                        </Typography>
                                    ...
                                    <Box sx={{ height: "40px", backgroundColor: "#2c3e50", display: "flex", alignItems: "center", justifyContent: "space-between", px: 2, }}>
                                        <Button
                                            variant="text"
                                            sx={{
                                                color: "#fff",
                                            ...
                                            startIcon={iconMap[form.downloadIcon]}
                                            href={form.download_pdf}
                                            target="_blank"
                                        >
                                            {form.download_btn}
                                        </Button>
                                        <Button
                                            ...
                                            endIcon={iconMap[form?.onlineEditFormIcon]}
                                        >
                                            {form?.onlineform_text}
                                        </Button>
                                    </Box>
                                </Box>
                            </Grid>
